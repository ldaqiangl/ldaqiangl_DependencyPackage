...
@implementation UIBarButtonItem (DQExt)
                                  ...
                                  action:(SEL)action
{
    ...
    if (nil != title && title.length)
    {
        ...
        else
        {
            ...
            [barButton setTitleColor:[UIColor colorWithHexString_DQExt:@"#333333"]
                            forState:UIControlStateNormal];
            [barButton setTitleColor:[UIColor colorWithHexString_DQExt:@"#333333"]
                            forState:UIControlStateHighlighted];
            [barButton setTitleColor:[UIColor colorWithHexString_DQExt:@"#A8A8A8"]
        ...
        {
            [barButton setImage:[self img_DQExt:normalImg]
                       forState:UIControlStateNormal];
            [barButton setImage:[self img_DQExt:highlightImg]
                       forState:UIControlStateHighlighted];
        }
    }
    else
    {
        if (nil != normalImg && normalImg.length)
        {
            [barButton setBackgroundImage:[self img_DQExt:normalImg]
                                 forState:UIControlStateNormal];
            [barButton setBackgroundImage:[self img_DQExt:highlightImg]
                                 forState:UIControlStateHighlighted];
        }
    }
...
+ (UIBarButtonItem *)itemWithTitle_DQExt:(NSString *)title
                  ...
                  highlightedImage:(NSString *)highlightedImage
                            ...
                            action:(SEL)action
{
    return [[self alloc] initWithTitle_DQExt:title
...
/**
 ...
 @return UIImage
 */
- (UIImage *)img_DQExt:(NSString *)imgNameOrPath
{
...
@implementation UINavigationItem (DQExt)

#if __IPHONE_OS_VERSION_MAX_ALLOWED > __IPHONE_6_1
- (void)setLeftBarButtonItem_DQExt:(UIBarButtonItem *)_leftBarButtonItem
{
...
- (void)setRightBarButtonItem_DQExt:(UIBarButtonItem *)_rightBarButtonItem
{
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
    {
